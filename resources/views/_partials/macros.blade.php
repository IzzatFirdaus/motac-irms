...
{{--
    MOTAC SVG Logo Component

    This SVG graphic represents the MOTAC brand identity and can be used throughout the system.
    The colors have been updated to align with MOTAC's official color palette:
    - Primary Blue: #0055A4
    - Secondary colors and gradients maintain visual hierarchy

    Props:
    - height: SVG height (default: 78.5)
    - withbg: Optional background fill color
...
<svg width="57" height="{{ $height ?? '78.5' }}" viewBox="0 0 57 78.5" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g style="isolation: isolate">
    <g id="Layer_1" data-name="Layer 1">
      <g>
        <g>
          {{-- Main brand color elements - using MOTAC green/teal palette --}}
        ...
        {{-- Shadow/overlay elements for depth --}}
        ...
        <g>
          {{-- Primary brand elements with enhanced green palette --}}
          ...
          <path d="M78.5,54.9V66.8a20.8,20.8,0,0,1-1.3,7.1A24.5,24.5,0,0,0,54.3,57.2H41.2A19.7,19.7,0,0,1,21.5,38.5V27.8a20.8,20.8,0,0,1,1.3-7.1,23.9,23.9,0,0,0,5.9,9.5,24.4,24.4,0,0,0,17.4,7.2H58.9A19.8,19.8,0,0,1,78.5,54.9Z" transform="translate(-21.5 -8.1)" fill="#2BC07D"/>
          {{-- Highlight elements for visual depth --}}
          ...
          {{-- Accent color for additional branding elements --}}
        ...
        <g>
          {{-- Additional brand elements for visual balance --}}
