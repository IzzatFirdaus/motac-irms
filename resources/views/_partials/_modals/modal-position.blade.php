    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-md-4">
        <form wire:submit.prevent="submitPosition" id="positionFormModal" class="row g-3">
          <div class="col-md-6">
            <label for="positionNameModal" class="form-label w-100">{{ __('Nama Jawatan') }} <span class="text-danger">*</span></label>
          ...
          <div wire:ignore class="col-md-6">
            <label for="select2PositionGradeIdModal" class="form-label w-100">{{ __('Gred (Pilihan)') }}</label>
            <select wire:model='positionGradeId' id="select2PositionGradeIdModal" class="select2-position-grade form-select @error('positionGradeId') is-invalid @enderror" data-placeholder="{{ __('Pilih Gred') }}">
              ...
              {{-- $gradesForSelection should be passed from the parent Livewire component --}}
          ...
          <div class="col-12">
            <label for="positionDescriptionModal" class="form-label w-100">{{ __('Deskripsi (Pilihan)') }}</label>
