{{-- resources/views/loan-applications/loan-application-index.blade.php --}}
{{-- Main page for listing user's ICT loan applications --}}
{{-- Only the filename is changed; code and logic remain the same. --}}
...
@section('content')
                            ...
                            @foreach ($applications as $app)
                                <tr>
                                    ...
                                    <td class="px-3 py-2 small">
                                        ...
                                        <x-resource-status-panel :resource="$app" statusAttribute="status" type="loan_application" />
                                    </td>
    ...
    {{-- Modal for confirming loan application deletion --}}
...
@push('custom-scripts')
{{-- Script to set form action for delete modal --}}
<script>
