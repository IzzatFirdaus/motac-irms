...
@php
    ...
    } elseif ($approvableItem instanceof \App\Models\HelpdeskTicket) { // New Helpdesk Ticket Model
                    ...
                    <div class="card-body p-3 p-sm-4">
                        ...
                        @if ($approvableItem)
                            ...
                            @elseif ($approvableItem instanceof \App\Models\HelpdeskTicket)
                                {{-- Placeholder for Helpdesk Ticket Details Panel --}}
                                <div class="card shadow-sm mb-4">
                                    ...
                                    <div class="card-body p-4">
                                        <dl class="row g-3 small">
                                            ...
                                            {{-- Add more helpdesk ticket specific details here --}}
                                        </dl>
                                    </div>
                                </div>
                            @endif
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (decisionSelect) {
                    const toggleRequiredElements = () => {
                        ...
                        // The JS below will then control its visibility based on the 'APPROVED' status.
