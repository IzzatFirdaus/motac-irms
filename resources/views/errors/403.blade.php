...
@section('page-style')
  ...
  <style>
    .misc-wrapper .display-5 { color: var(--bs-danger); }
    .motac-error-illustration { max-width: 250px; }
  </style>
@endsection
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper text-center">
    ...
    <div class="mt-4">
      ...
      <img src="{{ asset('assets/img/illustrations/motac-error-403' . $illustrationStyleSuffix . '.png') }}" {{-- Placeholder path --}}
           alt="{{ __('Ilustrasi Akses Dihalang') }}"
           width="200" class="img-fluid motac-error-illustration">
    </div>
  </div>
</div>
{{--
