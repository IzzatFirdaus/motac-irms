{{-- resources/views/loan-transactions/loan-transaction-index.blade.php --}}
...
<<<<<<< HEAD
                                            ...
                                            <td class="px-3 py-2 text-end">
                                                {{-- Route to view details for this transaction --}}
...
>>>>>>> d2dd0a5 (more edited codes and new files 29/5/25)
                ...
                {{-- Show pagination if $loanTransactions uses pagination --}}
