...
@php
    ...
    // Theme-specific variable to optionally hide customizer UI
    $customizerHidden = 'customizer-hide';
@endphp

@extends('layouts.app') {{-- Use the main MOTAC layout for consistent theme, menu, light/dark support --}}

@section('title', __('policy.title')) {{-- Translation key for policy page title --}}

@push('page-style')
    {{-- Style to improve Markdown content readability --}}
    <style>
        .card-body-markdown {
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4 card-body-markdown">
                        ...
                        {!! Str::markdown(__('policy.content')) !!}
                    </div>
                </div>
