{{-- resources/views/profile/delete-user-form-profile.blade.php (MOTAC Bootstrap 5 Version, renamed for naming convention) --}}
<div class="card shadow-sm motac-card border-danger"> {{-- Added border-danger for emphasis --}}
    ...
    <script>
        // JavaScript for initializing and syncing modal state with Livewire and Alpine.js
