{{-- resources/views/profile/update-profile-information-form-profile.blade.php (MOTAC Bootstrap 5 Version, renamed for naming convention) --}}
<div class="card shadow-sm motac-card">
    ...
    <form wire:submit.prevent="updateProfileInformation">
        <div class="card-body p-3 p-md-4">
            ...
            {{-- Add other MOTAC-specific profile fields here as needed --}}
        </div>
