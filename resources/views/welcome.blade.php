...
@extends('layouts.app') {{-- Uses the MOTAC-themed layout for the main app --}}

@section('title', __('Selamat Datang ke Sistem MOTAC')) {{-- Page title, translatable --}}

@section('content')
    <div class="container py-5">
        {{-- Jumbotron section for system introduction --}}
        <div class="p-5 mb-4 bg-light rounded-3 shadow-sm">
            <div class="container-fluid py-4 text-center">
                {{-- Display MOTAC/system logo using Blade component --}}
                ...
                {{-- Authenticated users get dashboard button --}}
                @auth
                ...
                <div class="card h-100 shadow-sm motac-card">
                    <div class="card-body p-4">
                        <h2 class="h5 fw-bold mb-3 text-primary">
                            <i class="bi bi-laptop me-2"></i>{{ __('Pinjaman Peralatan ICT') }}
                        </h2>
                        <p class="small">
                ...
                <div class="card h-100 shadow-sm motac-card">
                    <div class="card-body p-4">
                        <h2 class="h5 fw-bold mb-3 text-success">
                            <i class="bi bi-headset me-2"></i>{{ __('Sistem Meja Bantuan IT') }}
                        </h2>
                        <p class="small">
        ...
        {{-- Useful resources, guides, and contacts --}}
