{{-- resources/views/admin/positions/position-show.blade.php --}}
@extends('layouts.app')
                        ...
                        <dl class="row g-2 small">
                            ...
                            <dd class="col-sm-8 col-lg-9">
                                @if ($position->is_active)
                                    <span class="badge rounded-pill bg-success-subtle text-success-emphasis">{{ __('Aktif') }}</span>
                                @else
                                    <span class="badge rounded-pill bg-danger-subtle text-danger-emphasis">{{ __('Tidak Aktif') }}</span>
                                @endif
                            </dd>
