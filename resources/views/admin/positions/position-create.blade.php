{{-- resources/views/admin/positions/position-create.blade.php --}}
@extends('layouts.app')

@section('title', __('Tambah Jawatan Baru'))
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                    <h1 class="h2 fw-bold text-dark mb-0">{{ __('Tambah Jawatan Baru') }}</h1>
                ...
                <form action="{{ route('admin.positions.store') }}" method="POST">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body p-3 p-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name') }}"
                                    placeholder="{{ __('Masukkan nama jawatan, cth: Pegawai Teknologi Maklumat') }}">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" id="code"
                                    ...
                                    value="{{ old('code') }}" placeholder="{{ __('Cth: PTM, PTPO') }}">
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="{{ __('Keterangan tambahan mengenai jawatan ini') }}">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-footer text-end bg-light py-3">
                            <a href="{{ route('admin.positions.index') }}" class="btn btn-outline-secondary me-2">
