                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body p-3 p-md-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6"> {{-- System Design users.name is the full name, while app commonly uses 'name' for display/username and 'full_name' for the actual full name. Assuming form 'full_name' maps to a field like `real_full_name` or combines with `title` for `name` on User model. --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="service_status" id="service_status"
                                        ...
                                        {{-- Assuming $serviceStatuses is available, mapping to users.service_status enum --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="appointment_type" id="appointment_type"
                                        ...
                                        {{-- Assuming $appointmentTypes is available, mapping to users.appointment_type enum --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        {{-- Assuming $userStatuses contains 'active' => 'Aktif', 'inactive' => 'Tidak Aktif' --}}
                                ...
                                {{-- Employee ID from request (if creating user from employee link) --}}
