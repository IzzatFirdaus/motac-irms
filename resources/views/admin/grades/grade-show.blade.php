{{-- resources/views/admin/grades/grade-show.blade.php --}}
@extends('layouts.app')
                        ...
                        <dl class="row g-2 small">
                            ...
                            <dd class="col-sm-8 col-lg-9 text-dark">
                                @if ($grade->is_approver_grade)
                                    <span class="badge rounded-pill bg-success-subtle text-success-emphasis">{{ __('Ya') }}</span>
                                @else
                                    <span class="badge rounded-pill bg-danger-subtle text-danger-emphasis">{{ __('Tidak') }}</span>
                                @endif
                            </dd>

                            <dt class="col-sm-4 col-lg-3 fw-medium text-muted">{{ __('Gred Minimum Untuk Meluluskan') }}</dt>
                            <dd class="col-sm-8 col-lg-9 text-dark">
