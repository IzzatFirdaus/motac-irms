{{-- resources/views/admin/profiles/profile-edit.blade.php --}}
    ...
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-xl-8">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between mb-4 pb-3 border-bottom">
                    <div>
                        ...
                        <div class="card-body p-4 p-lg-5">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @include('admin.profiles.partials.input-email', [
                                            ...
                                            // 'readonly' => true, // Consider making this readonly or separate process
                                        ])
                                    </div>
                                    <div class="col-md-6">
                                        @include('admin.profiles.partials.input-text', [
                            ...
                            <section class="mb-2">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        {{-- Spacer or other security settings --}}
                                    </div>
                                    <div class="col-md-6">
                                        @include('admin.profiles.partials.input-password', [
                                            'name' => 'password',
                                            'label' => __('Kata Laluan Baru (Biarkan kosong jika tidak mahu tukar)'),
                                            'placeholder' => __('Masukkan kata laluan baru'),
                                            'hint' => __('Minimum 8 aksara. Lebih kuat dengan gabungan huruf, nombor & simbol.'),
                                        ])
                                    </div>
                                    <div class="col-md-6">
                                        @include('admin.profiles.partials.input-password', [
...
@push('custom-scripts')
    <script>
        // Password toggle for all password fields with .password-toggle
