{{-- resources/views/partials/report-filters-partial.blade.php --}}
{{-- Blade partial for reusable report filters form (date, status, user, department) --}}
@props([
...
<div class="card shadow-sm mb-4 motac-card"> {{-- Consistent MOTAC card styling --}}
