{{--
    ...
    MOTAC application logo SVG component with gradient effects.
    ...
    Note: Uses viewBox for scalability and includes gradient definitions
--}}
<svg viewbox="0 0 148 80" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    {{-- Main Logo Path --}}
    <path style="fill: #0055A4;" transform="translate(-.1)"
