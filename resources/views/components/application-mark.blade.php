{{--
    ...
    A simplified mark/icon version of the application logo.
    Uses currentColor for dynamic theming support.

    Usage:
    <x-application-mark class="w-8 h-8 text-primary" />
    <x-application-mark style="width: 32px; height: 32px; color: #0055A4;" />

    Note: Responsive to parent's color property via currentColor
--}}
