...
@section('content')
    <div class="container-fluid px-lg-4 py-4">
        ...
        {{-- Livewire Flash Messages (Replaced @include('_partials._alerts.alert-general')) --}}
        ...
        <div class="card shadow-sm motac-card">
            ...
            <div class="card-body">
                <form wire:submit.prevent="saveUser">
                    {{-- No need for @csrf with Livewire submit --}}
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="title" wire:model.blur="title"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="passport_number" wire:model.blur="passport_number"
                        ...
                        <div class="col-md-6">
                            <label for="personal_email"
                                class="form-label fw-medium">{{ __('E-mel Peribadi (Untuk Log Masuk)') }} <span
                                    class="text-danger">*</span></label>
                            <input type="email" id="personal_email" wire:model.blur="personal_email"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" id="motac_email" wire:model.blur="motac_email"
                        ...
                        <div class="col-md-6">
                            <label for="mobile_number"
                                class="form-label fw-medium">{{ __('No. Telefon Bimbit') }} <span
                                    class="text-danger">*</span></label>
                            <input type="tel" id="mobile_number" wire:model.blur="mobile_number"
                        ...
                        <div class="col-md-6">
                            <label for="department_id"
                                class="form-label fw-medium">{{ __('Jabatan/Bahagian') }} <span
                                    class="text-danger">*</span></label>
                            <select id="department_id" wire:model.blur="department_id"
                        ...
                        <div class="col-md-6">
                            <label for="position_id" class="form-label fw-medium">{{ __('Jawatan') }} <span
                                    class="text-danger">*</span></label>
                            <select id="position_id" wire:model.blur="position_id"
                        ...
                        <div class="col-md-6">
                            <label for="grade_id" class="form-label fw-medium">{{ __('Gred') }} <span
                                    class="text-danger">*</span></label>
                            <select id="grade_id" wire:model.blur="grade_id"
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="level" wire:model.blur="level"
                        ...
                        <div class="col-md-6">
                            <label for="service_status"
                                class="form-label fw-medium">{{ __('Taraf Perkhidmatan') }} <span
                                    class="text-danger">*</span></label>
                            <select id="service_status" wire:model.blur="service_status"
                        ...
                        <div class="col-md-6">
                            <label for="appointment_type"
                                class="form-label fw-medium">{{ __('Jenis Pelantikan') }} <span
                                    class="text-danger">*</span></label>
                            <select id="appointment_type" wire:model.blur="appointment_type"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="previous_department_name"
                                wire:model.blur="previous_department_name"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" id="previous_department_email"
                                wire:model.blur="previous_department_email"
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="selectedRoles" wire:model.blur="selectedRoles"
