<<<<<<<< HEAD:resources/views/livewire/settings/users/index.blade.php
...
>>>>>>>> 6c5c9a3 (Refactor and update Livewire components, service integration, and route imports for modular resource management, admin settings, and error-free system routing.):resources/views/livewire/settings/users/users-index.blade.php
...
>>>>>>> 6452504 (MAJOR CODE UPDATE PROGRESS 2/6/25)
                    </select>
                </div>
            </div>
        </div>
