<div>
                ...
                <div class="card-body">
                    <div class="row g-0 align-items-center">
                        <div class="col">
                            ...
                            <div class="h5 mb-0 fw-bold text-dark">{{ $pending_email_applications_count }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row g-0 align-items-center">
                        <div class="col">
                            ...
                            <div class="h5 mb-0 fw-bold text-dark">{{ $processing_email_applications_count }}</div>
                        </div>
                        <div class="col-auto">
    ...
    {{-- Recent Activity / Pending Applications Table --}}
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm mb-4 motac-card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between motac-card-header">
                    ...
                    {{-- Link to the full list of applications for IT Admins [cite: 312, 523] --}}
