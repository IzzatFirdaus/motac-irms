...
<div class="container-fluid py-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-24">
        <h1 class="heading-medium fw-semibold text-black-900 mb-0">{{ __('Papan Pemuka Pegawai Pelulus') }}</h1>
        @if (Route::has('approvals.history'))
            <a href="{{ route('approvals.history') }}" class="button variant-secondary size-small d-inline-flex align-items-center">
    ...
    {{-- Statistical summary --}}
    <div class="row">
    <div class="col-lg-6 mb-24 py-16">
