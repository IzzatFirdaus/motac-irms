    ...
    <div class="d-flex justify-content-between align-items-center mb-2 mt-3">
        <div class="d-flex align-items-center">
            <div class="d-flex flex-column align-items-center me-3">
                <img src="{{ asset('assets/img/logo/logo_bpm.png') }}" alt="@lang('forms.bpm_office_display')"
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                    class="bi bi-person-lines-fill me-2 fs-5"></i>@lang('forms.section_applicant_info_ict')</h2>
                            <small class="text-muted">@lang('messages.instruction_mandatory_fields')</small>
                        </div>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label fw-medium">@lang('forms.label_full_name')</label>
                                <p class="form-control-plaintext p-2 border rounded bg-light-subtle mb-0">
                                    {{ $applicantName }}</p>
                            </div>
                            <div class="col-md-6"><label for="applicant_phone"
                                    class="form-label fw-medium">@lang('forms.label_phone_number')</label><input type="text"
                                    id="applicant_phone" wire:model.blur="applicant_phone"
                            ...
                            <div class="col-md-6"><label class="form-label fw-medium">@lang('forms.label_position_grade')</label>
                                <p
                                    class="form-control-plaintext p-2 border rounded bg-light-subtle mb-0>
                            ...
                            <div class="col-md-6"><label for="location"
                                    class="form-label fw-medium">@lang('forms.label_location_ict')</label><input type="text"
                                    id="location" wire:model.blur="location"
                            ...
                            <div class="col-md-6"><label for="return_location"
                                    class="form-label fw-medium">@lang('forms.label_expected_return_location')</label><input type="text"
                                    id="return_location" wire:model.blur="return_location"
                            ...
                            <div class="col-md-6"><label for="loan_start_date"
                                    class="form-label fw-medium">@lang('forms.label_loan_date')</label><input type="datetime-local"
                                    id="loan_start_date" wire:model.blur="loan_start_date"
                            ...
                            <div class="col-md-6"><label for="loan_end_date"
                                    class="form-label fw-medium">@lang('forms.label_expected_return_date')</label><input type="datetime-local"
                                    id="loan_end_date" wire:model.blur="loan_end_date"
                ...
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                    class="bi bi-tools me-2 fs-5"></i>@lang('forms.section_equipment_details_ict') <span
                                    class="text-danger">*</span></h2>
                            <button type="button" wire:click="addLoanItem" class="btn btn-sm btn-outline-primary"><i
                                    class="bi bi-plus-lg me-1"></i> @lang('app.button_add_equipment')</button>
                        </div>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    @if (count($loan_application_items) > 1)
                                        <button type="button" wire:click="removeLoanItem({{ $index }})"
                                            ...
                                            class="btn btn-sm btn-icon btn-text-danger p-0"><i
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select id="item_{{ $index }}_equipment_type"
                                            ...
                                            {{-- The $label already contains the translated text, so just print it --}}
                                    ...
                                    <div class="col-md-6"><label for="item_{{ $index }}_quantity_requested"
                                            class="form-label">@lang('forms.label_quantity')</label><input type="number"
                                    ...
                                    <div class="col-md-12"><label for="item_{{ $index }}_notes"
                                            class="form-label">@lang('forms.label_remarks')</label><input type="text"
            ...
            <div class="col-lg-5">
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                class="bi bi-person-check-fill me-2 fs-5"></i>@lang('forms.section_responsible_officer_info')</h2>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                        <div class="form-check mb-3"><input id="applicant_is_responsible_officer"
                                wire:model.live="applicant_is_responsible_officer" type="checkbox"
                                class="form-check-input"><label for="applicant_is_responsible_officer"
                                class="form-check-label fw-medium">@lang('forms.instruction_responsible_officer_is_applicant')</label></div>
                        @if (!$applicant_is_responsible_officer)
                            <div class="row g-3">
                                <div class="col-md-12"><label for="responsible_officer_id"
                                        class="form-label fw-medium">@lang('forms.label_responsible_officer_name')<span
                                            class="text-danger">*</span></label>
                                    <div wire:ignore><select id="responsible_officer_id"
                ...
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                class="bi bi-person-badge-fill me-2 fs-5"></i>@lang('forms.section_supporting_officer_info') <span
                                class="text-danger">*</span></h2>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                        <div class="mb-3"><label for="supporting_officer_id"
                                class="form-label fw-medium">@lang('forms.label_supporting_officer_name')</label>
                            <div wire:ignore><select id="supporting_officer_id" wire:model="supporting_officer_id"
                            ...
                            </div><small class="form-text text-muted">@lang('forms.text_supporter_grade_requirement', ['grade' => config('motac.approval.min_loan_support_grade_level', 41)])</small>
                ...
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                class="bi bi-card-checklist me-2 fs-5"></i>@lang('messages.terms_ict_loan_title')</h2>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                        <div id="termsBox"
                ...
                <div class="card motac-card mb-4">
                    <div class="card-header motac-card-header p-3">
                        <h2 class="h5 mb-0 fw-semibold d-flex align-items-center"><i
                                class="bi bi-patch-check-fill me-2 fs-5"></i>@lang('forms.section_applicant_confirmation_ict')</h2>
                    </div>
                    <div class="card-body p-4 motac-card-body">
                        <div class="form-check"><input id="applicant_confirmation"
                                wire:model="applicant_confirmation" type="checkbox" value="1"
                                class="form-check-input @error('applicant_confirmation') is-invalid @enderror"
                                x-model="applicantConfirmation"><label for="applicant_confirmation"
                                class="form-check-label fw-medium">@lang('forms.text_applicant_declaration_ict')<span
                                    class="text-danger">*</span></label>
        ...
        <div class="d-flex justify-content-end gap-2 pt-3">
            @if ($isEditMode && $loanApplicationInstance)
                <a href="{{ route('loan-applications.print', ['loan_application' => $loanApplicationInstance->id]) }}"
                    target="_blank" class="btn btn-outline-secondary d-inline-flex align-items-center"><i
                        class="bi bi-printer-fill me-1"></i>@lang('app.button_print_form')</a>
            @endif

            {{-- New container for loading indicators --}}
            <div class="d-inline-flex align-items-center me-2" wire:loading.delay
            ...
            <button type="submit" wire:loading.attr="disabled" @click="clearCache()" class="btn btn-primary"
                ...
                <i
                    class="bi bi-send-check-fill me-1"></i>{{ $isEditMode && $this->loanApplicationInstance?->status !== \App\Models\LoanApplication::STATUS_DRAFT ? __('forms.button_update_and_resubmit') : __('app.button_submit_application') }}
            </button>
        </div>
    </form>
</div>
