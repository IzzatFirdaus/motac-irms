...
<div style="text-align: center; padding-bottom: 15px; border-bottom: 1px solid #e0e0e0; margin-bottom: 20px;">
    ...
    <h1 style="font-size: 20px; color: #0055A4; margin:0;">{{ config('app.name', __('Sistem Pengurusan Sumber MOTAC')) }}</h1>
</div>
...
@slot('subcopy')
    <p style="text-align: center; font-size: 12px; color: #777777; line-height: 1.5em;">
        ...
        &copy; {{ date('Y') }} {{ __('Kementerian Pelancongan, Seni dan Budaya Malaysia') }}. {{ __('Hak Cipta Terpelihara.') }}
    </p>
@endslot
@endcomponent
