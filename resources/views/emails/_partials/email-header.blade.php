...
<div style="text-align: center; padding-bottom: 15px; border-bottom: 1px solid #e0e0e0; margin-bottom: 20px;">
    ...
    <h1 style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 20px; color: #0055A4; margin:0;">{{ config('app.name', __('Sistem Pengurusan Sumber MOTAC')) }}</h1>
</div>
