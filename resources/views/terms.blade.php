...
@section('page-style')
    {{-- Ensure page-auth.css aligns with or is overridden by MOTAC theme for elements within $terms --}}
    <link rel="stylesheet" href="{{ asset('assets/vendor/css/pages/page-auth.css') }}">
    <style>
        /* Ensure Noto Sans and MOTAC text colors are applied to content from $terms if not handled by blankLayout */
        .card-body {
        ...
        <div class="authentication-inner" style="max-width: 800px; margin: auto;"> {{-- Centering content --}}
            ...
            <div class="card shadow-sm"> {{-- Added shadow-sm for subtle depth --}}
                <div class="card-body p-4 p-md-5"> {{-- Added more padding --}}
                    {!! $terms !!} {{-- Content comes from this variable --}}
                </div>
            </div>
