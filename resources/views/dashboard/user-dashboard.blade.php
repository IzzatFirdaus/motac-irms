                        ...
                        <div class="mt-auto w-100">
                            @can('create', App\Models\HelpdeskTicket::class)
                                <a href="{{ route('helpdesk.create') }}"
                                   class="motac-btn-primary mt-auto btn-sm w-100">{{ __('dashboard.create_new_ticket') }}</a>
                            @else
                    ...
                    <div class="motac-card-body d-flex flex-column justify-content-center align-items-center text-center p-4">
                        ...
                        <div class="mt-auto w-100">
                                     <a href="{{ route('helpdesk.index') }}"
                                         class="motac-btn-primary mt-auto btn-sm w-100">{{ __('dashboard.view_all_my_tickets') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="mt-auto w-100">
                            @can('create', App\Models\LoanApplication::class)
                                <a href="{{ route('loan-applications.create') }}"
                                   class="motac-btn-primary mt-auto btn-sm w-100">{{ __('dashboard.apply_new_loan') }}</a>
                            @else
                                <button type="button" class="motac-btn-outline mt-auto btn-sm w-100" disabled>
                                    {{ __('dashboard.no_permission') }}
                                </button>
                    ...
                    <div class="motac-card-body d-flex flex-column justify-content-center align-items-center text-center p-4">
                        ...
                        <div class="mt-auto w-100">
                                     <a href="{{ route('loan-applications.index') }}"
                                         class="motac-btn-primary mt-auto btn-sm w-100">{{ __('dashboard.view_my_loan_applications') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="motac-card shadow-sm h-100">
                    <div class="motac-card-body d-flex flex-column justify-content-center align-items-center text-center p-4">
                        ...
                        <a href="{{ route('notifications.index') }}"
                            class="motac-btn-primary mt-auto btn-sm w-100">{{ __('dashboard.view_all_notifications') }}</a>
                    </div>
                </div>
            </div>
        </div>
