...
class LoanApplicationPolicyTest extends TestCase
{
  ...
  public function test_any_user_can_view_any_loan_application_list()
  {
    $this->assertTrue($this->policy->viewAny($this->applicant)->allowed());
  }

  public function test_applicant_can_view_own_loan_application()
  {
  ...
  public function test_any_authenticated_user_can_create_loan_application()
  {
    $this->assertTrue($this->policy->create($this->applicant)->allowed());
  }

  public function test_applicant_can_update_own_draft_loan_application()
  {
  ...
  public function test_applicant_cannot_update_own_submitted_loan_application()
  {
    $application = LoanApplication::factory()->make([
      'user_id' => $this->applicant->id,
  ...
  public function test_applicant_can_submit_their_own_draft_application()
  {
    $application = LoanApplication::factory()->make([
      'user_id' => $this->applicant->id,
      'status' => LoanApplication::STATUS_DRAFT
  ...
  public function test_user_cannot_submit_another_users_application()
  {
  ...
  public function test_supporting_officer_with_correct_grade_can_record_decision()
  {
  ...
  public function test_bpm_staff_can_process_issuance()
  {
  ...
  public function test_applicant_cannot_process_issuance()
  {
    $application = LoanApplication::factory()->make(['status' => LoanApplication::STATUS_APPROVED]);
    $this->assertFalse($this->policy->processIssuance($this->applicant, $application)->allowed());
  }

  public function test_bpm_staff_can_process_return()
  {
