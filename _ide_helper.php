...
namespace Illuminate\Support\Facades {
    ...
    class Lang {
        ...
        {
            /** @var \App\Translation\SuffixedTranslator $instance */
        ...
        {
            /** @var \App\Translation\SuffixedTranslator $instance */
            return $instance->getMissingKeys();
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
            \App\Translation\SuffixedTranslator::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
            \App\Translation\SuffixedTranslator::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
            return \App\Translation\SuffixedTranslator::hasMacro($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Translation\Translator
            \App\Translation\SuffixedTranslator::flushMacros();
        }
...
namespace Barryvdh\DomPDF\Facade {
     ...
     * @method static BasePDF setTree(\Dompdf\Frame\FrameTree $tree)
     */
    // Duplicate class Pdf definition removed
