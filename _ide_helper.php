...
namespace Barryvdh\Debugbar\Facades {
    ...
    class Debugbar {
        ...
        public static function setStorage($storage = null)
        {
            //Method inherited from \DebugBar\DebugBar
            /** @var \Barryvdh\Debugbar\LaravelDebugbar $instance */
            // Ensure $storage is either null or an instance of DebugBar\Storage\StorageInterface
            if (!is_null($storage) && !($storage instanceof \DebugBar\Storage\StorageInterface)) {
                throw new \InvalidArgumentException('Expected type null|\DebugBar\Storage\StorageInterface for $storage.');
            }
...
namespace Imanghafoori\LaravelMicroscope\Features\CheckRoutes {
    ...
    class SpyRouter {
        ...
        {
            return \Imanghafoori\LaravelMicroscope\Features\CheckRoutes\SpyRouter::webhooks($url, $name, $method);
        }
