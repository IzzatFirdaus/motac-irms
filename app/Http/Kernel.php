...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // It's highly recommended to configure and uncomment TrustHosts for production
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\LocaleMiddleware::class, // Crucial for localization [cite: 8]
    ...
    protected $middlewareAliases = [
        ...
        //'validate.webhook.signature' => \App\Http\Middleware\ValidateWebhookSignature::class, // Ensure this class exists

        // Placeholder for custom grade-based authorization middleware if implemented
