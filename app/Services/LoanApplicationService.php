...
final class LoanApplicationService
{
    ...
    public function createAndSubmitApplication(array $validatedData, User $applicant, bool $saveAsDraftOnly = false): LoanApplication
    {
        ...
        return DB::transaction(function () use ($validatedData, $applicantId, $saveAsDraftOnly) {
        ...
        return DB::transaction(function () use ($application, $submitter, $supportingOfficer) {
            ...
            if ($supportingOfficer) {
                ...
                if ($assignedOfficerForNextStage) {
                    ...
                    Log::error(self::LOG_AREA."No officer found for Approver Review stage. Application ID: {$application->id} may not have an active approval task.");
            ...
            // ##### FIX APPLIED HERE #####
            // Corrected the function call to pass only one argument as expected.
