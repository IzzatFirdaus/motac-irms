...
class EmailApplication extends Model
{
    ...
    protected $fillable = [
        'user_id',
        'applicant_title', 'applicant_name', 'applicant_identification_number', 'applicant_passport_number',
        'applicant_jawatan_gred', 'applicant_bahagian_unit', 'applicant_level_aras',
        ...
        'purpose', // This was 'application_reason_notes' in older design, ensure consistency
        'application_reason_notes', // Keep both if migration has both, or consolidate to one. 'purpose' used in your latest EmailApplication.php
        ...
        'certification_timestamp', 'submitted_at',
    ...
    public static function getStatuses(): array { return array_keys(self::$STATUS_OPTIONS); }

    // Ensure User::getServiceStatusDisplayName exists or use this model's version
    public static function getServiceStatusDisplayName(string $statusKey): string
    {
        // Prefer User model's method if available and centralized
