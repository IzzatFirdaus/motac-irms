...
class AdminDashboard extends Component
{
  ...
  public function fetchDashboardStats(): void
  {
    ...
    $this->equipment_utilization_rate = Equipment::getUtilizationRate();
    $this->equipment_status_summary = Equipment::getStatusSummary();
    ...
    $this->loan_issued_count = LoanApplication::whereIn('status', [
    ...
    $this->total_active_loans_count = $this->loan_issued_count;

    $this->overdue_loans_count = LoanApplication::query()
      ->overdue()
      ->count();
  }
