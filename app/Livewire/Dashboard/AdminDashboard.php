 ...
 *
 * Displays key statistics and charts for admin users.
 */
class AdminDashboard extends Component
{
    ...
    /**
     * Fetches all dashboard statistics for display.
     */
    public function fetchDashboardStats(): void
    {
        ...
        $this->equipment_utilization_rate = Equipment::getUtilizationRate(); // Assumes static method exists
        $this->equipment_status_summary   = Equipment::getStatusSummary(); // Assumes static method exists
    }

    /**
     * Prepares chart data for the loan status doughnut chart.
     */
    ...
    /**
     * Render the dashboard Blade view.
     */
