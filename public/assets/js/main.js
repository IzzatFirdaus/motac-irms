...
(function () {
  ...
  layoutMenuEl.forEach(function (element) {
    ...
    // MODIFIED THE FOLLOWING TWO LINES (from original: window.Helpers.scrollToActive((animate = false));)
    animate = false; // Explicitly set animate
    window.Helpers.scrollToActive(false); // Pass the boolean value directly
  ...
  $(function () {
    ...
    if (searchInput.length) {
      ...
      searchInput.each(function () {
        var $this = $(this);
        searchInput // This should ideally be $this.typeahead, but searchInput.typeahead also works if only one searchInput. Let's keep as is for now as this was not the error point.
          .typeahead(
            {
              hint: false,
              classNames: {
