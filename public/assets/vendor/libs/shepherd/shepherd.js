...
(function (global, factory) {
  ...
  function _detectOverflow() {
    _detectOverflow = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(state, options) {
      var _await$platform$isEle, x, y, platform, rects, elements, strategy, _options5, _options5$boundary, boundary, _options5$rootBoundar, rootBoundary, _options5$elementCont, elementContext, _options5$altBoundary, altBoundary, _options5$padding, padding, paddingObject, altContext, element, clippingClientRect, rect, offsetParent, offsetScale, elementClientRect, _t12, _t13, _t14, _t15, _t16, _t17, _t18, _t19, _t20, _t21, _t22, _t23, _t24, _t25, _t26, _t27, _t28;
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.n) {
          case 0:
            ...
            _t12 = rectToClientRect;
            _t13 = platform;
            _context7.n = 1;
            return platform.isElement == null ? void 0 : platform.isElement(element);
          case 1:
            _t14 = _await$platform$isEle = _context7.v;
            if (!(_t14 != null)) {
              _context7.n = 2;
              break;
            }
            _t15 = _await$platform$isEle;
            _context7.n = 3;
            break;
          case 2:
            _t15 = true;
          ...
          case 7:
            ...
            _context7.n = 8;
            return _t13.getClippingRect.call(_t13, _t22);
          case 8:
            _t23 = _context7.v;
            clippingClientRect = _t12(_t23);
  ...
  var platform = {
    ...
    getElementRects: function getElementRects(_ref) {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
        var reference, floating, strategy, getOffsetParentFn, getDimensionsFn, _t4, _t5, _t6, _t7, _t8, _t9, _t0, _t1, _t10;
    ...
    return _createClass(Tour, [{
      ...
      value: (function () {
        var _cancel = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
          var confirmCancelIsFunction, cancelMessage, stopTour, _t11;
          return _regenerator().w(function (_context6) {
            while (1) switch (_context6.n) {
              ...
              case 1:
                ...
                break;
              case 2:
                _t11 = window.confirm(cancelMessage);
              case 3:
                stopTour = _t11;
                if (stopTour) {
                  this._done('cancel');
