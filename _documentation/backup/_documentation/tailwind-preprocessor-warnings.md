...
**Note:** These files require a preprocessor (e.g., SASS/SCSS) and are not natively supported by
Tailwind CSS v4+. Refactor or process them with a compatible build tool if needed.
