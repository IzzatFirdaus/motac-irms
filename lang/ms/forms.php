...
return [
  ...
  // ==============================================================================
  'label_required_field' => '* WAJIB diisi',
  ...
  // ==============================================================================
  'email_app_create_title' => 'Borang Permohonan E-mel / ID Pengguna MOTAC',
  'email_app_edit_title' => 'Kemaskini Draf Permohonan Emel/ID',

  'section_applicant_info_email' => 'MAKLUMAT PEMOHON',
  'text_profile_info_note' => '(Maklumat diambil dari profil pengguna anda)',

  'section_application_details' => 'BUTIRAN PERMOHONAN',
  'label_service_status' => 'Taraf Perkhidmatan',
  'label_appointment_type' => 'Pelantikan',
  'label_previous_department' => 'Jabatan Terdahulu',
  'label_previous_email' => 'E-mel Rasmi Jabatan Terdahulu',
  'label_application_purpose_notes' => 'Tujuan Permohonan / Catatan',
  'placeholder_application_purpose' => 'Nyatakan tujuan dan cadangan emel jika ada...',
  'label_proposed_email' => 'Cadangan E-mel (Jika Ada)',
  'placeholder_proposed_email' => 'cth: nama.anda@motac.gov.my',
  'text_proposed_email_help' => 'Biarkan kosong jika tiada cadangan spesifik. Format: pengguna@motac.gov.my',

  'section_group_email_info' => 'Maklumat Group E-mel / E-mel Agensi Luar',
  'label_group_email_name' => 'Nama Group E-mel / E-mel Rasmi Agensi',
  'label_contact_person_name' => 'Nama Pegawai Dihubungi (Admin/EO/CC)',
  'label_contact_person_email' => 'E-mel Pegawai Dihubungi (Rasmi MOTAC)',
  'text_contact_person_email_help' => 'Sila pastikan e-mel adalah e-mel rasmi MOTAC.',

  'label_service_start_date' => 'Tarikh Mula Berkhidmat (Jika Berkaitan)',
  'label_service_end_date' => 'Tarikh Akhir Berkhidmat (Jika Berkaitan)',

  'section_supporting_officer_info' => 'MAKLUMAT PEGAWAI PENYOKONG',
  'text_supporter_instruction' => 'Permohonan hendaklah DISOKONG oleh Pegawai sekurang-kurangnya Gred 9 dan ke atas SAHAJA.',
  'label_supporter_full_name' => 'Nama Penuh Pegawai Penyokong',
  'placeholder_supporter_name' => 'Cth: Nur Faridah Jasni',
  'label_supporter_grade' => 'Gred Pegawai Penyokong',
  'label_supporter_email' => 'Emel Rasmi Pegawai Penyokong',
  'placeholder_supporter_email' => 'Cth: nur.faridah@motac.gov.my',
  ...
  'checkbox_info_is_true' => 'Semua maklumat yang diberikan di dalam borang ini adalah BENAR.',
  'checkbox_data_usage_agreed' => 'Saya BERSETUJU Bahagian Pengurusan Maklumat (BPM) menggunakan maklumat yang diberikan untuk memproses permohonan ini.',
  'checkbox_email_responsibility_agreed' => 'Saya BERSETUJU untuk bertanggungjawab ke atas setiap e-mel yang dihantar dan diterima melalui akaun e-mel ini.',
  'text_all_certifications_required' => 'Sila tandakan semua kotak perakuan untuk meneruskan permohonan.',
