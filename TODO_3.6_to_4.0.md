...
This checklist tracks all required updates for the 4.0 release, including removal of the Email/User
ID Provisioning module and addition of a Helpdesk module. Each item includes a description, the
related files, and a "Done" status to be marked once completed.
...
| 7   | Remove EmailApplication model & migration                                  | app/Models/EmailApplication.php, database/migrations/create_email_applications_table.php                                                                                                                                                                      | Partial   |
| 8   | Remove EmailAccount/EmailApplication controllers                           | app/Http/Controllers/EmailApplicationController.php, EmailAccountController.php, Api/EmailProvisioningController.php                                                                                                                                          | Yes   |
...
| 13  | Remove EmailApplication-related routes                                     | routes/web.php, routes/api.php (Route::resource('email-applications', ...), Route::resource('email-accounts', ...), /email-\* routes)                                                                                                                         | Yes   |
...
| 16  | Remove email-related fields from users table if not needed elsewhere       | database/migrations, app/Models/User.php, config/motac.php                                                                                                                                                                                                    | Partial   |
...
| 19  | Remove email provisioning from language/translation files                  | resources/lang/en/_.php, resources/lang/ms/_.php                                                                                                                                                                                                              | No   |
...
- Controllers: app/Http/Controllers/EmailApplicationController.php, EmailAccountController.php,
...
- Views: resources/views/email-applications/,
...
- Migrations: database/migrations/create_email_applications_table.php,
  create_email_accounts_table.php
...
- Lang Files: resources/lang/en/_.php, resources/lang/ms/_.php (email/email_application related)
- Tests: tests/Feature/EmailApplicationTest.php, tests/Unit/EmailApplicationServiceTest.php,
  Dusk/email-related tests
- Navigation/Menu: resources/menu/verticalMenu.json (Email Provisioning)
- Documentation: docs/Email_Feature_Implementation.md, references in docs/System_Design_Rev_3.6.md,
  etc.

---

## Audit snapshot (automated scan results)

- app/Models/EmailApplication.php — PRESENT (minimal stub) ✅
- database/migrations/`*remove_email_provisioning_components*.php` — PRESENT (migration drops email_applications and user columns) ✅
- database/migrations/create_email_applications_table.php — REMOVED / replaced by cleanup migration (dropped) ✅
- app/Http/Controllers/EmailApplicationController.php — NOT FOUND (removed) ✅
- app/Http/Controllers/EmailAccountController.php — NOT FOUND (removed) ✅
- app/Http/Controllers/Api/EmailProvisioningController.php — NOT FOUND (removed) ✅
- resources/views/email-applications/ — PRESENT (views still in repo) ⚠️
- resources/views/email-accounts/ — PRESENT (views still in repo) ⚠️
- resources/views/emails/application-`*`.blade.php — SOME PRESENT (check templates) ⚠️
- app/Services/EmailApplicationService.php, EmailProvisioningService.php — NOT FOUND (removed) ✅
- app/Livewire/ResourceManagement/EmailAccount/ — NOT FOUND (removed) ✅

Notes:

- A cleanup migration exists (2025_08_02... and 2025_08_25...) that drops the `email_applications` table and removes columns from `users`. This indicates database removal was applied as part of migration history.
- View templates (resources/views/email-applications and email-accounts) remain; decide whether to delete them or move to an archive/docs folder.
- Documentation still references removed classes; documentation updates are still required.
