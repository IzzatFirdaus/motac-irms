        ...
        <div class="modal-content myds-modal-content">
            <div class="modal-header myds-modal-header">
                <h2 class="heading-small d-flex align-items-center mb-0" id="deleteConfirmationModalLabel">
                    ...
                    <?php echo e(__('Sahkan Pemadaman Peralatan')); ?>
            ...
            <div class="modal-body myds-modal-body py-24 px-24">
                ...
                <!--[if BLOCK]><![endif]--><?php if($equipmentInstance): ?>
                    <p class="heading-xsmall"><?php echo e(__('Adakah anda pasti ingin memadam peralatan')); ?> <strong>#<?php echo e($equipmentInstance->tag_id); ?></strong>?</p>
                    <p class="text-danger-500 fw-semibold heading-xsmall"><?php echo e(__('Tindakan ini tidak boleh diundur.')); ?></p>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
            <div class="modal-footer myds-modal-footer">
                <button type="button" class="button variant-secondary size-medium" wire:click="resetForm"><?php echo e(__('Batal')); ?></button>
                <button type="button" class="button variant-danger size-medium" wire:click="deleteEquipment" wire:loading.attr="disabled">
                    <span wire:loading.remove><?php echo e(__('Ya, Padam')); ?></span>
                    <span wire:loading><?php echo e(__('Memadam...')); ?></span>
                </button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\motac-irms\resources\views/livewire/resource-management/admin/equipment/partials/delete-confirmation-modal.blade.php ENDPATH**/ ?>