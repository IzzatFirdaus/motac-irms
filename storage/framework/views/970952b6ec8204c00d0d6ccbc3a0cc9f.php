...
<div>
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        <?php echo e(__('Helpdesk Ticket Management')); ?>
            ...
            <div class="row mb-3">
                <div class="col-md-3 mb-2">
                    <input type="text" class="form-control"
                        ...
                        placeholder="<?php echo e(__('Search tickets...')); ?>">
                </div>
                <div class="col-md-2 mb-2">
                    <select class="form-select" wire:model="status">
                        ...
                        <option value="reopened"><?php echo e(__('Reopened')); ?></option>
                ...
                <div class="col-md-3 mb-2">
                    <select class="form-select" wire:model="assigned_to_user_id">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->staffUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" wire:click="viewTicketDetails(<?php echo e($ticket->id); ?>)" class="text-primary">
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" wire:click="openAssignTicketModal(<?php echo e($ticket->id); ?>)"><?php echo e(__('Assign')); ?></button>
                                    <button class="btn btn-sm btn-outline-success" wire:click="openChangeStatusModal(<?php echo e($ticket->id); ?>)"><?php echo e(__('Change Status')); ?></button>
                                    <button class="btn btn-sm btn-outline-secondary" wire:click="openAddCommentModal(<?php echo e($ticket->id); ?>)"><?php echo e(__('Add Comment')); ?></button>
                                    <button class="btn btn-sm btn-outline-danger" wire:click="openCloseTicketModal(<?php echo e($ticket->id); ?>)"><?php echo e(__('Close')); ?></button>
                                </td>
                            </tr>
...
<?php /**PATH C:\laragon\www\motac-irms\resources\views/livewire/helpdesk/admin/ticket-management.blade.php ENDPATH**/ ?>