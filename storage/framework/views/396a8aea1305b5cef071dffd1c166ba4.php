...
<script src="<?php echo e($assetsPath); ?>vendor/libs/jquery/jquery.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/libs/popper/popper.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/js/bootstrap.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/libs/node-waves/node-waves.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/js/menu.js"></script>


<script src="<?php echo e($assetsPath); ?>vendor/libs/toastr/toastr.js"></script>
<script src="<?php echo e($assetsPath); ?>vendor/libs/sweetalert2/sweetalert2.js"></script>
<?php echo $__env->yieldContent('vendor-script'); ?>


<script src="<?php echo e($assetsPath); ?>js/main.js"></script>
...
<?php /**PATH C:\laragon\www\motac-irms\resources\views/layouts/sections/layout-scripts.blade.php ENDPATH**/ ?>