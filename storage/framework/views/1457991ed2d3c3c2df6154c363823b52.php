...
<div>
    ...
    <form wire:submit.prevent="createTicket" enctype="multipart/form-data" class="py-16">
        <!--[if BLOCK]><![endif]--><?php if(session()->has('message')): ?>
            <div class="alert alert-success-500 mb-24"><?php echo e(session('message')); ?></div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <?php if(session()->has('error')): ?>
            <div class="alert alert-danger-500 mb-24"><?php echo e(session('error')); ?></div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

        <div class="mb-24">
            <label class="form-label fw-semibold text-black-900"><?php echo e(__('Title')); ?></label>
            <input type="text" class="form-control input size-medium" wire:model.defer="title">
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger-500"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        </div>
        <div class="mb-24">
            <label class="form-label fw-semibold text-black-900"><?php echo e(__('Description')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="row">
            <div class="col-md-6 mb-24">
                <label class="form-label fw-semibold text-black-900"><?php echo e(__('Category')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="col-md-6 mb-24">
                <label class="form-label fw-semibold text-black-900"><?php echo e(__('Priority')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="mb-24">
            <label class="form-label fw-semibold text-black-900"><?php echo e(__('Attachments (optional)')); ?></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <button class="button variant-primary size-medium" type="submit"><?php echo e(__('Submit Ticket')); ?></button>
    </form>
</div>
<?php /**PATH C:\laragon\www\motac-irms\resources\views/livewire/helpdesk/create-ticket-form.blade.php ENDPATH**/ ?>