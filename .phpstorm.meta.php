...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'motac.mymail_form_options.appointment_types.aras_options.' => 'string',
            'motac.mymail_form_options.appointment_types.supporting_officer_grades.' => 'string',
            'motac.mymail_form_options.appointment_types.supporting_officer_grades.Turus III' => 'string',
            'motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa A' => 'string',
            'motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa B' => 'string',
            'motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa C' => 'string',
            'motac.mymail_form_options.loan_accessories_list' => 'array',
            'motac.mymail_form_options.notifications.admin_email_recipient' => 'string',
            'motac.mymail_form_options.date_formats.date_my' => 'string',
            'motac.mymail_form_options.date_formats.datetime_my' => 'string',
            'motac.mymail_form_options.session_lifetime' => 'string',
...
'actAsSupportingOfficer','processByIT','processIssue','processReturn','approve',
'processIssuance','createIssue','createReturn','viewAnyIssued','manageRoles',
'viewSensitiveData',);
...
'app.aliases.Helper','app.available_locales.ms.name','app.available_locales.ms.script','app.available_locales.ms.native','app.available_locales.ms.regional',
'app.available_locales.ms.direction','app.available_locales.ms.display','app.available_locales.en.name','app.available_locales.en.script','app.available_locales.en.native',
'app.available_locales.en.regional','app.available_locales.en.direction','app.available_locales.en.display','app.date_format_my_short','app.date_format_my_long',
'app.datetime_format_my','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'cache.stores.octane.driver','cache.stores.apc.driver','cache.stores.|-microscope-|.driver','cache.stores.|-microscope-|.path','cache.prefix',
'cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers',
'cors.exposed_headers','cors.max_age','cors.supports_credentials','custom.custom.myLayout','custom.custom.myTheme',
'custom.custom.myStyle','custom.custom.myRTLSupport','custom.custom.myRTLMode','custom.custom.hasCustomizer','custom.custom.displayCustomizer',
'custom.custom.menuFixed','custom.custom.menuCollapsed','custom.custom.navbarFixed','custom.custom.navbarDetached','custom.custom.footerFixed',
'custom.custom.showDropdownOnHover','custom.custom.container','custom.custom.containerNav','custom.custom.contentNavbar','custom.custom.isMenu',
'custom.custom.isNavbar','custom.custom.isFooter','custom.custom.isFlex','custom.custom.primaryColor','custom.custom.customizerControls',
...
'filesystems.disks.s3.throw','filesystems.links.C:\\XAMPP\\htdocs\\MOTAC_ICT_LOAN_HRMS\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','jetstream.stack','jetstream.middleware',
'jetstream.features','jetstream.profile_photo_disk','jetstream.auth_session','jetstream.guard','livewire.class_namespace',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','menu.menu.0.url','menu.menu.0.name',
'menu.menu.0.icon','menu.menu.0.slug','menu.menu.0.routeName','menu.menu.0.role','menu.menu.1.menuHeader',
'menu.menu.1.name','menu.menu.1.role','menu.menu.2.name','menu.menu.2.icon','menu.menu.2.slug',
'menu.menu.2.role','menu.menu.2.submenu.0.url','menu.menu.2.submenu.0.name','menu.menu.2.submenu.0.slug','menu.menu.2.submenu.0.routeName',
'menu.menu.2.submenu.0.role','menu.menu.2.submenu.1.url','menu.menu.2.submenu.1.name','menu.menu.2.submenu.1.slug','menu.menu.2.submenu.1.routeName',
'menu.menu.2.submenu.1.role','menu.menu.3.name','menu.menu.3.icon','menu.menu.3.slug','menu.menu.3.role',
'menu.menu.3.submenu.0.url','menu.menu.3.submenu.0.name','menu.menu.3.submenu.0.slug','menu.menu.3.submenu.0.routeName','menu.menu.3.submenu.1.url',
'menu.menu.3.submenu.1.name','menu.menu.3.submenu.1.slug','menu.menu.3.submenu.1.routeName','menu.menu.4.url','menu.menu.4.name',
'menu.menu.4.icon','menu.menu.4.slug','menu.menu.4.routeName','menu.menu.4.role','menu.menu.5.name',
'menu.menu.5.icon','menu.menu.5.slug','menu.menu.5.routeNamePrefix','menu.menu.5.role','menu.menu.5.submenu.0.name',
'menu.menu.5.submenu.0.icon','menu.menu.5.submenu.0.slug','menu.menu.5.submenu.0.routeNamePrefix','menu.menu.5.submenu.0.role','menu.menu.5.submenu.0.submenu.0.url',
'menu.menu.5.submenu.0.submenu.0.name','menu.menu.5.submenu.0.submenu.0.slug','menu.menu.5.submenu.0.submenu.0.routeName','menu.menu.5.submenu.0.submenu.1.url','menu.menu.5.submenu.0.submenu.1.name',
'menu.menu.5.submenu.0.submenu.1.slug','menu.menu.5.submenu.0.submenu.1.routeName','menu.menu.5.submenu.1.url','menu.menu.5.submenu.1.name','menu.menu.5.submenu.1.icon',
'menu.menu.5.submenu.1.slug','menu.menu.5.submenu.1.routeName','menu.menu.5.submenu.1.role','menu.menu.5.submenu.2.url','menu.menu.5.submenu.2.name',
'menu.menu.5.submenu.2.icon','menu.menu.5.submenu.2.slug','menu.menu.5.submenu.2.routeName','menu.menu.5.submenu.2.role','menu.menu.5.submenu.3.url',
'menu.menu.5.submenu.3.name','menu.menu.5.submenu.3.icon','menu.menu.5.submenu.3.slug','menu.menu.5.submenu.3.routeName','menu.menu.5.submenu.3.role',
'menu.menu.6.menuHeader','menu.menu.6.name','menu.menu.6.role','menu.menu.7.name','menu.menu.7.icon',
'menu.menu.7.slug','menu.menu.7.routeNamePrefix','menu.menu.7.role','menu.menu.7.submenu.0.url','menu.menu.7.submenu.0.name',
'menu.menu.7.submenu.0.slug','menu.menu.7.submenu.0.routeName','menu.menu.7.submenu.1.url','menu.menu.7.submenu.1.name','menu.menu.7.submenu.1.slug',
'menu.menu.7.submenu.1.routeName','menu.menu.7.submenu.2.url','menu.menu.7.submenu.2.name','menu.menu.7.submenu.2.slug','menu.menu.7.submenu.2.routeName',
'menu.menu.7.submenu.3.url','menu.menu.7.submenu.3.name','menu.menu.7.submenu.3.slug','menu.menu.7.submenu.3.routeName','menu.menu.7.submenu.4.url',
'menu.menu.7.submenu.4.name','menu.menu.7.submenu.4.slug','menu.menu.7.submenu.4.routeName','menu.menu.8.name','menu.menu.8.icon',
'menu.menu.8.slug','menu.menu.8.routeNamePrefix','menu.menu.8.role','menu.menu.8.submenu.0.url','menu.menu.8.submenu.0.name',
'menu.menu.8.submenu.0.slug','menu.menu.8.submenu.0.routeName','menu.menu.8.submenu.1.url','menu.menu.8.submenu.1.name','menu.menu.8.submenu.1.slug',
'menu.menu.8.submenu.1.routeName','menu.menu.8.submenu.2.url','menu.menu.8.submenu.2.name','menu.menu.8.submenu.2.slug','menu.menu.8.submenu.2.routeName',
'menu.menu.8.submenu.3.url','menu.menu.8.submenu.3.name','menu.menu.8.submenu.3.slug','menu.menu.8.submenu.3.routeName','menu.menu.8.submenu.3.role',
...
'motac.approval.min_email_supporting_officer_grade_level','motac.approval.min_general_view_approval_grade_level','motac.email_provisioning.api_endpoint','motac.email_provisioning.api_key','motac.email_provisioning.default_domain',
...
'motac.mymail_form_options.appointment_types.baharu','motac.mymail_form_options.appointment_types.kenaikan_pangkat_pertukaran','motac.mymail_form_options.appointment_types.lain_lain','motac.mymail_form_options.appointment_types.aras_options.','motac.mymail_form_options.appointment_types.supporting_officer_grades.',
'motac.mymail_form_options.appointment_types.supporting_officer_grades.Turus III','motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa A','motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa B','motac.mymail_form_options.appointment_types.supporting_officer_grades.Jusa C','motac.mymail_form_options.loan_accessories_list',
'motac.mymail_form_options.notifications.admin_email_recipient','motac.mymail_form_options.date_formats.date_my','motac.mymail_form_options.date_formats.datetime_my','motac.mymail_form_options.session_lifetime','permission.models.permission',
...
'sanctum.middleware.verify_csrf_token','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'webhook-client.add_unique_token_to_route_name','concurrency.default','activitylog.enabled','activitylog.delete_records_older_than_days','activitylog.default_log_name',
...
'user-password.update','password.confirm','password.confirmation','password.confirm.store','profile.show',
...
'api.auth.user','api.v1.email-accounts.provision','language.swap','contact-us','webhooks.deploy',
'terms.show','policy.show','dashboard','equipment.index',
...
'loan-applications.destroy','loan-applications.submit','resource-management.bpm.outstanding-loans','resource-management.bpm.issued-loans','resource-management.bpm.loan-transactions.issue.form',
'resource-management.bpm.loan-transactions.return.form','resource-management.bpm.loan-transactions.show','resource-management.equipment-admin.index','resource-management.equipment-admin.create','resource-management.equipment-admin.store',
'resource-management.equipment-admin.show','resource-management.equipment-admin.edit','resource-management.equipment-admin.update','resource-management.equipment-admin.destroy','resource-management.email-applications-admin.index',
'resource-management.email-applications-admin.show','resource-management.email-applications-admin.process','resource-management.users-admin.index','settings.users.index','settings.users.create',
'settings.users.show','settings.users.edit','settings.roles.index','settings.permissions.index','settings.grades.index',
'settings.grades.create','settings.grades.store','settings.grades.show','settings.grades.edit','settings.grades.update',
'settings.grades.destroy','settings.departments.index','settings.positions.index','reports.index','reports.equipment-inventory',
'reports.loan-applications','reports.user-activity','reports.email-accounts','reports.loan-history',);
...
'admin.equipment.create','admin.equipment.edit','admin.equipment.index','admin.equipment.show','admin.grades.create',
'admin.grades.edit','admin.grades.index','admin.grades.show','admin.positions.create','admin.positions.edit',
'admin.positions.index','admin.positions.show','admin.profiles.edit','admin.profiles.partials.input-email','admin.profiles.partials.input-password',
'admin.profiles.partials.input-text','admin.users.create','admin.users.edit','admin.users.index','admin.users.show',
'api.api-token-manager','api.index','approvals.comments','approvals.history','approvals.index',
'approvals.show','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.two-factor-challenge','auth.verify-email','components.action-message','components.action-section',
'components.alert','components.applicant-details-readonly','components.application-logo','components.application-mark','components.approval-status-badge',
'components.authentication-card','components.authentication-card-logo','components.back-button','components.banner','components.button',
'components.card','components.checkbox','components.confirmation-modal','components.confirms-password','components.danger-button',
'components.dialog-modal','components.dropdown','components.dropdown-link','components.form-section','components.input',
'components.input-error','components.label','components.modal','components.nav-link','components.resource-status-panel',
'components.responsive-nav-link','components.secondary-button','components.section-border','components.section-title','components.sort-icon',
'components.switchable-team','components.user-info-card','components.validation-errors','components.welcome','content.pages-misc-error',
'dashboard.admin','dashboard.approver','dashboard.bpm','dashboard.user','email-accounts.create',
'email-accounts.show','email-applications.create','email-applications.edit','email-applications.index','email-applications.show',
'emails._partials.email-header','emails.application-submitted-notification','emails.email-application-approved','emails.email-application-rejected','emails.loan-application-issued',
'emails.loan-application-overdue-reminder','emails.loan-application-rejected','emails.loan-application-returned','emails.notifications.motac_default_notification','emails.team-invitation',
'emails.welcome','equipment.create','equipment.edit','equipment.index','equipment.show',
...
'livewire.settings.positions.index','livewire.settings.roles.index','livewire.settings.users.create-user','livewire.settings.users.index','livewire.shared.table-filters',
'livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','loan-applications.create',
'loan-applications.index','loan-applications.show','loan-transactions.index','loan-transactions.issue','loan-transactions.issued',
'loan-transactions.issued-list','loan-transactions.outstanding-loans','loan-transactions.return','loan-transactions.show','notifications.index',
'notifications.motac_default','partials.report-filters','partials.sidebar','policy','profile.delete-user-form',
...
'reports.activity-log','reports.email-accounts','reports.email-accounts-report','reports.equipment-inventory','reports.equipment-report',
'reports.index','reports.loan-applications','reports.loan-applications-report','reports.loan-history','reports.user-activity-report',
'terms','transactions.issue','transactions.return','users.index','users.show',
'vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind','vendor.livewire.tailwind','laravel-exceptions-renderer::components.card',
...
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','log-viewer::index','microscope_package::actions_comment',
...
'forms.search_by_id_purpose_applicant','messages.instruction_two_factor_auth_info','messages.instruction_two_factor_enabled_prompt','messages.instruction_two_factor_setup_qr','messages.instruction_two_factor_store_recovery_codes',
'messages.instruction_delete_account_warning','messages.instruction_delete_account_confirmation','messages.instruction_update_password_security','messages.instruction_browser_session_management','messages.notification_new_singular',
'messages.notification_new_plural','messages.notification_no_new','messages.notification_refresh','messages.service_unavailable_maintenance','messages.no_details_available',
'messages.no_recent_email_id_requests','messages.no_recent_ict_loan_requests','messages.no_approval_tasks_filtered','messages.no_quick_actions','messages.success_profile_updated',
'messages.success_password_updated','messages.error_form_validation','messages.info_processing_decision','messages.info_loading_approvals','messages.info_offline',
'messages.info_page_not_found_explanation','messages.info_access_forbidden_explanation','messages.info_not_authorized_explanation','messages.info_menu_not_loaded','messages.info_role_not_assigned',
'messages.info_user_guest','messages.info_user_unknown','messages.info_thank_you','messages.info_computer_generated_email','messages.info_quick_actions_unavailable',
'messages.info_start_day_check_tasks','messages.info_page_undergoing_updates','messages.message_no_details','messages.message_not_specified','messages.auth_two_factor_title',
'messages.auth_two_factor_enabled','messages.auth_two_factor_not_enabled','messages.auth_manage_browser_sessions','messages.auth_logout_other_sessions','messages.auth_delete_account_title',
'messages.auth_delete_account_permanently','messages.auth_update_password_title','messages.auth_profile_information_title','messages.auth_update_profile_information_description','messages.auth_saved',
'messages.auth_email_unverified','messages.auth_resend_verification_email','messages.auth_new_verification_link_sent','messages.auth_this_device','messages.auth_last_active',
'messages.keywords_meta','my.0','validation.custom.newLeaveInfo.fromDate.after_or_equal','validation.custom.newLeaveInfo.toDate.after_or_equal','validation.attributes.name',
...
'validation.attributes.responsible_officer_id','validation.attributes.applicationItems','validation.attributes.applicationItems.*.equipment_type','validation.attributes.applicationItems.*.quantity_requested','validation.attributes.selectedEmployeeId',
'validation.attributes.newLeaveInfo.LeaveId','validation.attributes.newLeaveInfo.fromDate','validation.attributes.newLeaveInfo.toDate','validation.attributes.newLeaveInfo.startAt','validation.attributes.newLeaveInfo.endAt',
'validation.attributes.newLeaveInfo.note',);
...
'THEME_NAVBAR_DETACHED','THEME_FOOTER_FIXED','THEME_HORIZONTAL_MENU_HOVER','THEME_CONTENT_CONTAINER','THEME_NAVBAR_CONTAINER',
'THEME_PRIMARY_COLOR_MOTAC',);
